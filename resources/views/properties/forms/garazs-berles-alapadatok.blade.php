<h3>Garázs Bérbeadás feladás</h3>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-3">
            ...
            <div class="form-group">
                <div class="input-group">
                  <label for="price" class="">Bérleti díj(Ft/hó)*</label>
                  <input class="form-control" type="number" name="price" id="price"  required />
                  <span class="input-group-addon">Ft</span> 
                </div>
            </div>
            <div class="form-group">
              <label for="deposit" class="">Kaució összege(Ft):*</label>
                <div class="input-group">
                  <input class="form-control" type="number" name="deposit" id="deposit"  required />
                  <span class="input-group-addon">Ft</span>
                </div> 
            </div>
            <div class="form-group">
              <label for="lease" class="">Bérleti szerződés</label>
