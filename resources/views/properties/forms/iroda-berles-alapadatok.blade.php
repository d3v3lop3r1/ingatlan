<h3>Iroda Bérbeadás feladás</h3>
<form action="adatrogzites.php" method="post" name="iroda_eladas" >
<input type="hidden" name="lista_tipus" value="2" />
<input type="hidden" name="tipus" value="6" />
      <div class="container">
        <div class="row">
        <!-- Első oszlop  -->
          <div class="col-lg-3 col-md-3">
            ...
            <div class="form-group">
              <label for="tipus" class="" >Iroda típusa*</label>
                <select class="form-control" name="altipus" id="tipus">
                    <option value="irodaház"  >irodaház</option>
                    <option value="irodahelyiség irodaházban"  >irodahelyiség irodaházban</option>
                    <option value="családi házban"  >családi házban</option>
                    <option value="lakásban"  >lakásban</option>
                    <option value="egyéb iroda"  >egyéb iroda</option>
                </select>
            </div>
            <div class="form-group">
