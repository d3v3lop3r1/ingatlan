<h3>Ipari ingatlan Bérbeadás feladás</h3>
<form action="adatrogzites.php" method="post" name="ipari_eladas" >
      ...
      <div class="container">
        ...
        <!-- Első oszlop  -->
          <div class="col-lg-3 col-md-3">
            ...
            <div class="form-group">
              <label for="tipus" class="" >Ipari ingatlan típusa*</label>
                <select class="form-control" name="altipus" id="tipus">
                    <option value="műhely"  >műhely</option>
                    <option value="telephely"  >telephely</option>
