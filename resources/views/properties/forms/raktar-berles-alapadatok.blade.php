<h3>Raktár Bérbeadás feladás</h3>
<form action="adatrogzites.php" method="post" name="raktar_eladas" >
      ...
      <div class="container">
        ...
        <!-- Első oszlop  -->
          <div class="col-lg-3 col-md-3">
            ...
            <div class="form-group">
              <label for="tipus" class="" >Raktár típusa*</label>
                <select class="form-control" name="altipus" id="tipus">
                    <option value="raktárhelyiség"  >raktárhelyiség</option>
                    <option value="raktárbázis"  >raktárbázis</option>
                    <option value="logisztikai park"  >logisztikai park</option>
                </select>
            </div>
            <div class="form-group">
