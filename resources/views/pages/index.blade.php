                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="3">
                          ...
                          @endif
                          @if ($property->balcony)
                            <img class="pl-3" src="/images/extras_icons/balcony-icon-new.png" data-toggle="tooltip" data-placement="top" title="Az ingatlanban erkély található" height="50" alt="">
                          @endif
                          ...
                          @endif
                          @if ($property->garden)
                            <img class="pl-3" src="/images/extras_icons/garden-icon-new.png" data-toggle="tooltip" data-placement="top" title="Az ingatlanhoz kert tartozik" height="50" alt="">
                          @endif
                          @if ($property->terrace)
